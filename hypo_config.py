...
class DPOConfig(TrainingArguments):
    ...
    Args:
        ...
        im_gamma: float = 0.0  # Clipping threshold gamma for the reference margin.
        im_tau: float = 0.0  # Smoothing temperature; <= 0 uses hard clipping, > 0 uses a softplus approximation.
        im_enable: bool = True  # Enable the HyPO/IM modification; if False, fall back to standard DPO.
        avg_log_prob: bool = False  # Use average log-probability instead of summed log-probability.
    """
